      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            ...
            <a href="https://linkedin.com/in/https://www.linkedin.com/in/nelson-chingaipe-95a940324/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 bg-black hover:bg-gray-800 text-white rounded-lg transition-colors shadow-md">
